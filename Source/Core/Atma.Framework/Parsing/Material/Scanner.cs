...
public class Scanner {
	...
	void CheckLiteral() {
		switch (t.val) {
			...
			case "addressu": t.kind = 8; break;
			case "addressw": t.kind = 9; break;
			case "addressv": t.kind = 10; break;
			case "address": t.kind = 11; break;
			case "wrap": t.kind = 12; break;
			case "clamp": t.kind = 13; break;
			case "mirror": t.kind = 14; break;
			case "MaxAnisotropy": t.kind = 15; break;
			case "MaxMipLevel": t.kind = 16; break;
			case "MipMapLevelOfDetailBias": t.kind = 17; break;
			default: break;
		}
	}
