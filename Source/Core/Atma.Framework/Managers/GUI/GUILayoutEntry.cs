...
namespace zSprite
{
    internal class GUILayoutEntry
    {
        ...
        public AxisAlignedBox rect = new AxisAlignedBox(0, 0, 0, 0);
        public int stretchWidth;
        public int stretchHeight;
        private GUIStyle m_Style = GUIStyle.none;
        internal static AxisAlignedBox kDummyRect = new AxisAlignedBox(0f, 0f, 1f, 1f);
        ...
        {
            this.rect.minVector = new Vector2(x, this.rect.minVector.Y);
            this.rect.maxVector = new Vector2(x + width, this.rect.maxVector.Y);
            this.rect.UpdateCorners();
            //this.rect.X0 = x;
            //this.rect.Width = width;
        }
        public virtual void SetVertical(float y, float height)
        {
            this.rect.minVector = new Vector2(this.rect.minVector.X, y);
            this.rect.maxVector = new Vector2(this.rect.maxVector.X, y + height);
            this.rect.UpdateCorners();
            //this.rect.Y0 = y;
