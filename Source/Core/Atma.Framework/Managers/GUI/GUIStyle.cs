    ...
    public class GUIStyle
    {
        ...
        private BmFont font
        {
            get
            {
                ...
                if (_font == null)
                    _font = Root.instance.resources.findFont(fontName);
                return _font;
            }
        }
        ...
        internal void Draw(RenderManager graphics, AxisAlignedBox position, string text, bool isHover, bool isActive, bool on, bool hasKeyboardFocus)
        {
        ...
        internal void Draw(RenderManager graphics, AxisAlignedBox position, GUIContent content, bool isHover, bool isActive, bool on, bool hasKeyboardFocus)
        {
