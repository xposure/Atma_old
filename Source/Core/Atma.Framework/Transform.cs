...
namespace Atma
{
    ...
    public class Transform : DisposableComponent
    {
        ...
        public override void dispose()
        {
            if (children != null)
            {
                //just dettach the children for now
                //we could move them up the tree but what if the parent was already
                //removed, how far back the tree do we check? need more vars to track?
