...
namespace Atma.Common
{
    ...
    {
        // tAKEN FROM http://theinstructionlimit.com/flash-style-tweeneasing-functions-in-c
        ...
        static class Sine
        {
            ...
            {
                return (float)Math.Sin(s * MathHelper.PiOver2 - MathHelper.PiOver2) + 1;
            }
            public static float EaseOut(double s)
            {
                return (float)Math.Sin(s * MathHelper.PiOver2);
            }
            public static float EaseInOut(double s)
            {
                return (float)(Math.Sin(s * MathHelper.Pi - MathHelper.PiOver2) + 1) / 2;
            }
        }
