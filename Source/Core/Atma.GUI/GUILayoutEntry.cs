...
namespace Atma
{
    internal class GUILayoutEntry
    {
        ...
        {
            this.rect.SetExtents(new Vector2(x, this.rect.Minimum.Y), new Vector2(x + width, this.rect.Maximum.Y));
        ...
        {
            this.rect.SetExtents(new Vector2(this.rect.Minimum.X, y), new Vector2(this.rect.Maximum.X, y + height));
            //this.rect.UpdateCorners();
            //this.rect.Y0 = y;
