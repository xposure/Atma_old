...
//     <id value="$Id: Plane.cs 2940 2012-01-05 12:25:58Z borrillis $"/>
// </file>
...
namespace Atma
{
    ...
    public struct Plane
    {
        ...
        public Plane(Vector3 point0, Vector3 point1, Vector3 point2)
        {
            ...
            this.Normal = edge1.Cross(edge2);// Vector3.Cross(edge1, edge2);
            this.Normal.Normalize();
            this.D = -this.Normal.Dot(point0);// Vector3.Dot(this.Normal, point0);
        }
        ...
        public PlaneSide GetSide(Vector3 centre, Vector3 halfSize)
        {
            ...
            float dist = this.GetDistance(centre);

            // Calculate the maximise allows absolute distance for
            // the distance between box centre and plane
            float maxAbsDist = this.Normal.AbsDot(halfSize);
