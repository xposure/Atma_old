...
public struct Ray2
{
    ...
    {
        return MathHelper.Intersects(this, box);
    }
    ...
    //{
    //    return MathHelper.Intersects(this, plane);
    //}
    ...
    {
        return MathHelper.Intersects(this, circle);
    }
    ...
    //{
    //    return MathHelper.Intersects(this, volume);
    //}
    ...
    public float Angle { get { return (float)MathHelper.ATan(direction.Y, direction.X); } }
