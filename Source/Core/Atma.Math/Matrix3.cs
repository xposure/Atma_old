...
//     <id value="$Id: Matrix3.cs 2940 2012-01-05 12:25:58Z borrillis $"/>
// </file>
...
namespace Atma
{
	...
	public struct Matrix3
	{
		...
		{
			Real cos = MathHelper.Cos( yaw );
			Real sin = MathHelper.Sin( yaw );
		...
		public Vector3 ToEulerAnglesXYZ()
		{
			...
			pAngle = MathHelper.ASin( m01 );
			if( pAngle < MathHelper.PI / 2 )
			{
				if( pAngle > -MathHelper.PI / 2 )
				{
					yAngle = MathHelper.ATan2( m21, m11 );
					rAngle = MathHelper.ATan2( m02, m00 );
				}
				else
				{
					// WARNING. Not a unique solution.
					Real fRmY = (Real)MathHelper.ATan2( -m20, m22 );
			...
			{
				// WARNING. Not a unique solution.
				Real fRpY = MathHelper.ATan2( -m20, m22 );
				rAngle = 0.0f; // any angle works
				yAngle = fRpY - rAngle;
			}
