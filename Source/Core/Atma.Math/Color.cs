...
namespace Atma
{
    ...
    public struct Color : IComparable
    {
        ...
        public Real R { get { return r; } set { r = value; } }
        public Real G { get { return g; } set { g = value; } }
        public Real B { get { return b; } set { b = value; } }
        public Real A { get { return a; } set { a = value; } }
        ...
        {
            r = MathHelper.Clamp(r, 1.0f, 0.0f);
            g = MathHelper.Clamp(g, 1.0f, 0.0f);
            b = MathHelper.Clamp(b, 1.0f, 0.0f);
            a = MathHelper.Clamp(a, 1.0f, 0.0f);
        }
        ...
        {
            Color saturated;
            saturated.r = MathHelper.Clamp(r, 1.0f, 0.0f);
            saturated.g = MathHelper.Clamp(g, 1.0f, 0.0f);
            saturated.b = MathHelper.Clamp(b, 1.0f, 0.0f);
            saturated.a = MathHelper.Clamp(a, 1.0f, 0.0f);
